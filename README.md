...
---
## Ключ шифрования
><br/>Вы можете указать ключ шифрования с помощью файла <code>key.txt</code> в рабочей папки, и написать внутри него ключ шифрования любой длины. После этого скрипт будет учитывать присутствие ключа шифрования при кодирование файлов и при декодировании файла нужно иметь правильный ключ шифрования, в ином случае, файл будет битым.
