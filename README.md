...
---
## Ключ шифрования
><br/>Вы можете указать ключ шифрования с помощью файла <code>key.txt</code> в рабочей папки, ключ может быть любой длины. После этого скрипт будет применять ключа шифрования при кодирование файлов и декодировании файла, при этом нужно иметь правильный ключ шифрования, в ином случае, файл будет битым.
